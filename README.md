...
| :--- | :--- | :--- |
| [Digit Recognition](https://github.com/Avaneesh40585/Digit-Recognition) | CV | A PyTorch-based Convolutional Neural Network (CNN) for MNIST handwritten digit classification, implementing custom architecture, data augmentation, and regularization techniques. |
| [GPT2-From-Scratch](https://github.com/Avaneesh40585/GPT2-From-Scratch) | NLP | A PyTorch implementation of the GPT-2 architecture built for experimentation. Use it to train models on custom text or run inference using the original OpenAI weights. |
